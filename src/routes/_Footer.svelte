...
<svelte:body style="position: relative;" />
    ...
    <div class="footer-content">
      <ul class="footer-list">
        <li class="footer-item">
          <a
            ...
            target="_blank">How Rally Works</a
          >
          ...
          <ul class="footer-sublist">
            <li class="footer-sublist-item">
              <a
                ...
                class="footer-sublist-link rwp-nav-link">Beyond the Paywall</a
              >
            </li>
            <li class="footer-sublist-item">
              <a
                href="__BASE_SITE__/current-studies/facebook-pixel-hunt/"
                class="footer-sublist-link rwp-nav-link">Facebook Pixel Hunt</a
              >
            </li>
            <li class="footer-sublist-item">
              <a
      ...
      <ul class="footer-list">
        <li class="footer-item">
          ...
          >
          <ul class="footer-sublist">
            <li class="footer-sublist-link rwp-nav-link">
              <a
