<script>
  ...
  <Story
    ...
    args={{
      ...
      body: "To finish creating your account with Rally, you will need to verify your email address.",
  ...
  <Story
    ...
    args={{
      ...
      fontSize: "38px",
      title: "Check Your Email",
      body: "An email has been sent to [example@workmail.com] to reset your password",
      bodyText: "Need additional help?",
      linkText: "Contact Us",
      custom: "info-dialog",
      minHeight: "300px"
  ...
  <style>
    ...
    .body-text-action, .body-text-info {
      font-size: 15px;
      padding-top: 40px;
      color: #000000;
    }
