 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function p_(t){t=we(t,ie);const e=we(t.firestore,gt);return xv(Ei(e),t._key).then(n=>Ch(e,t,n))}class ia extends Xv{constructor(e){super(),this.firestore=e}convertBytes(e){return new Wt(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new ie(this.firestore,null,n)}}function g_(t){t=we(t,Gn);const e=we(t.firestore,gt),n=Ei(e),r=new ia(e);return Nh(t._query),Uv(n,t._query).then(i=>new kh(e,r,t,i))}function m_(t,e,n){t=we(t,ie);const r=we(t.firestore,gt),i=Yv(t.converter,e,n);return Rh(r,[Hv(_h(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,lt.none())])}function y_(t,e,n,...r){t=we(t,ie);const i=we(t.firestore,gt),s=_h(i);let o;return o=typeof(e=V(e))=="string"||e instanceof Ii?Kv(s,"updateDoc",t._key,e,n,r):zv(s,"updateDoc",t._key,e),Rh(i,[o.toMutation(t._key,lt.exists(!0))])}function v_(t,...e){var n,r,i;t=V(t);let s={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||mh(e[o])||(s=e[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges};if(mh(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(r=h.error)===null||r===void 0?void 0:r.bind(h),e[o+2]=(i=h.complete)===null||i===void 0?void 0:i.bind(h)}let c,u,l;if(t instanceof ie)u=we(t.firestore,gt),l=ti(t._key.path),c={next:h=>{e[o]&&e[o](Ch(u,t,h))},error:e[o+1],complete:e[o+2]};else{const h=we(t,Gn);u=we(h.firestore,gt),l=h._query;const d=new ia(u);c={next:f=>{e[o]&&e[o](new kh(u,d,h,f))},error:e[o+1],complete:e[o+2]},Nh(t._query)}return function(h,d,f,g){const v=new Qo(g),w=new Ko(d,v,f);return h.asyncQueue.enqueueAndForget(async()=>qo(await _i(h),w)),()=>{v.ec(),h.asyncQueue.enqueueAndForget(async()=>Ho(await _i(h),w))}}(Ei(u),l,a,c)}function Rh(t,e){return function(n,r){const i=new Ce;return n.asyncQueue.enqueueAndForget(async()=>_v(await Mv(n),r,i)),i.promise}(Ei(t),e)}function Ch(t,e,n){const r=n.docs.get(e._key),i=new ia(t);return new Ah(t,i,e._key,r,new Qn(n.hasPendingWrites,n.fromCache),e.converter)}(function(t,e=!0){(function(n){xt=n})(sn),rn(new St("firestore",(n,{options:r})=>{const i=n.getProvider("app").getImmediate(),s=new gt(i,new gm(n.getProvider("auth-internal")));return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC")),Me(Gu,"3.2.1",t),Me(Gu,"3.2.1","esm2017")})();var Jv="firebase",Zv="9.3.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
