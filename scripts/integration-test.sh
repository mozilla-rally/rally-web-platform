...
# firebase emulators:exec "npm run test:integration:jest -- --test_browser=chrome --load_extension=true --headless_mode=false" --import tests/integration/testdata 2>&1 | tee integration.log
